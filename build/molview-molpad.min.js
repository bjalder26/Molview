/*! MolView JavaScript Sketcher, built on 2022-03-22 */

var JmolAtomColorsHashHex = {
        D: "#111111",
        H: "#888888",
        He: "#849b9b",
        Li: "#c87efa",
...
function mapArray(t, e) {
    for (var o = 0; o < t.length; o++) void 0 !== e[t[o]] ? (t[o] = e[t[o]]) : (t.splice(o, 1), o--);
    return t;
}
...
function MPLine(t) {
    (this.from = (void 0 !== t && t.from.clone()) || new MPPoint()), (this.to = (void 0 !== t && t.to.clone()) || new MPPoint());
}
(MPPoint.prototype.clone = function () {
    ...
    (MPPoint.prototype.mirror = function (t, e) {
        ...
        var o,
            ...
            n = t.to.x - t.from.x,
            a = t.to.y - t.from.y;
        return Math.abs(n) < 0.001 ? (this.x = 2 * t.from.x - this.x) : ((o = a / n), (i = t.from.y - o * t.from.x), (s = (this.x + (this.y - i) * o) / (1 + o * o)), (this.x = 2 * s - this.x), (this.y = 2 * s * o - this.y + 2 * i)), !0;
    }),
    ...
    (MPPoint.prototype.rotateAroundCenter = function (t, e) {
        var o = this.x - t.x,
            i = this.y - t.y;
        (this.x = o * Math.cos(-e) - i * Math.sin(-e) + t.x), (this.y = o * Math.sin(-e) + i * Math.cos(-e) + t.y);
    }),
    ...
    (MPPoint.prototype.fromRelativePointer = function (t, e) {
        return (
            this.fromPointer(t),
            (this.x = (this.x - e.offset.left) * e.devicePixelRatio),
            (this.y = (this.y - e.offset.top) * e.devicePixelRatio),
            (this.x = (this.x - e.matrix[4]) / e.matrix[0]),
            (this.y = (this.y - e.matrix[5]) / e.matrix[3]),
            this
        );
    }),
    (MPPoint.prototype.fromMultiTouchCenter = function (t) {
        var e = t.originalEvent.targetTouches;
        if (1 < e.length) {
            (this.x = e[0].pageX), (this.y = e[0].pageY);
            for (var o = 1; o < e.length; o++) (this.x += e[o].pageX), (this.y += e[o].pageY);
            (this.x /= e.length), (this.y /= e.length);
        }
        return this;
    }),
    (MPLine.prototype.intersection = function (t) {
        ...
        if (0 == e) return { p: void 0, onL1: !1, onL2: !1 };
        var o = this.from.y - t.from.y,
            ...
            o = s / e,
            i = n / e;
        return { p: MPPFO({ x: this.from.x + o * (this.to.x - this.from.x), y: this.from.y + o * (this.to.y - this.from.y) }), onL1: 0 < o && o < 1, onL2: 0 < i && i < 1 };
    }),
...
var MPFragments = {
    ...
    generateRing: function (t, e) {
        var o = PI2 / t,
            i = (0.5 / Math.sin(o / 2)) * this.length;
        return { full: this.createRing(t, e ? 2 : 0), toAtom: this.translate(this.createRing(t, e ? 2 : 0), i, 0), toBond: this.rotate(this.translate(this.createRing(t, e ? 2 : 0), i, 0), { x: 0, y: 0 }, (Math.PI - o) / 2) };
    },
    createRing: function (t, e) {
        var o = { atoms: [], bonds: [] },
            i = PI2 / t;
        o.r = (0.5 / Math.sin(i / 2)) * this.length;
        for (var s = 0; s < t; s++)
            o.atoms.push({ center: new MPPoint(o.r * Math.cos(Math.PI + i * s), o.r * Math.sin(Math.PI + i * s)), element: "C" }),
                o.bonds.push({ from: s, to: s + 1 < t ? s + 1 : 0, type: 0 === e || s % 2 == 2 - e ? MP_BOND_SINGLE : MP_BOND_DOUBLE });
        return o;
    },
    clone: function (t) {
        for (var e = { atoms: [], bonds: [], r: t.r }, o = 0; o < t.atoms.length; o++) e.atoms.push({ center: t.atoms[o].center.clone(), element: t.atoms[o].element });
        for (o = 0; o < t.bonds.length; o++) e.bonds.push({ from: t.bonds[o].from, to: t.bonds[o].to, type: t.bonds[o].type });
        return e;
    },
    scale: function (t, e) {
...
(MPAtom.prototype.getX = function () {
    ...
    (MPAtom.prototype.getKetcherData = function () {
        return new chem.Struct.Atom({ pp: { x: this.center.x / this.mp.s.bond.length, y: this.center.y / this.mp.s.bond.length }, label: this.element, charge: this.charge, isotope: this.isotope });
    }),
    (MPAtom.prototype.getConfig = function () {
        return { i: this.index, x: this.center.x, y: this.center.y, element: this.element, charge: this.charge, isotope: this.isotope, bonds: this.bonds.slice() };
    }),
    (MPAtom.prototype.toString = function () {
        for (var t = this.center.x.toString() + "," + this.center.y.toString() + "," + this.element.toString() + "," + this.charge.toString() + "," + this.isotope.toString(), e = 0; e < this.bonds.length; e++)
            t += "," + this.mp.mol.bonds[this.bonds[e]].toString();
        return t;
    }),
    ...
    (MPAtom.prototype.setCenter = function (t, e) {
        this.center.replace(t, e), this.centerChanged();
    }),
    (MPAtom.prototype.setElement = function (t) {
        (this.element = "D" === t ? "H" : t), this.labelChanged();
    }),
    (MPAtom.prototype.setCharge = function (t) {
        (this.charge = t), this.labelChanged();
    }),
    (MPAtom.prototype.setIsotope = function (t) {
        (this.isotope = t), this.labelChanged();
    }),
    ...
    (MPAtom.prototype.getNeighborBond = function (t) {
        for (var e = 0; e < this.bonds.length; e++) if (this.mp.mol.bonds[this.bonds[e]].getOppositeAtom(this.index) === t) return this.bonds[e];
        return -1;
    }),
    (MPAtom.prototype.hasUnselectedNeighbors = function () {
        for (var t = 0; t < this.bonds.length; t++) if (!this.mp.mol.atoms[this.mp.mol.bonds[this.bonds[t]].getOppositeAtom(this.index)].isSelected()) return !0;
        return !1;
    }),
    ...
    (MPAtom.prototype.mapBonds = function (t) {
        ...
        (this.bonds = mapArray(this.bonds, t)), this.bonds.length !== e && this.bondsChanged();
    }),
    (MPAtom.prototype.replaceBond = function (t, e) {
        var o = this.bonds.indexOf(t),
            i = this.bonds.indexOf(e);
        -1 !== o && (-1 !== i ? this.bonds.splice(t, 1) : (this.bonds[o] = e)), this.bondsChanged();
    }),
    (MPAtom.prototype.addNewBond = function (t) {
        var e = new MPAtom(this.mp, { i: this.mp.mol.atoms.length, x: this.getX() + (t.length || this.mp.s.bond.length) * Math.cos(t.a), y: this.getY() - (t.length || this.mp.s.bond.length) * Math.sin(t.a), element: t.element || "C" }),
            o = new MPBond(this.mp, { i: this.mp.mol.bonds.length, type: t.type || MP_BOND_SINGLE, stereo: t.stereo || MP_STEREO_NONE, from: this.index, to: e.index });
        return this.mp.mol.atoms.push(e), this.mp.mol.bonds.push(o), e.addBond(o.index), this.addBond(o.index), { atom: e.index, bond: o.index, startAngle: t.a, currentAngle: t.a };
    }),
        ...
        if ("C" === this.element) {
            if (2 === this.getBondCount() && 2 === this.bonds.length) {
                ...
                if (indev(Math.max(t, e) - Math.min(t, e), Math.PI, this.mp.s.bond.angleDev)) {
                    ...
                    return this.addNewBond({ a: o[0], length: this.mp.s.bond.lengthHydrogen, element: "H" }), void this.addNewBond({ a: o[1], length: this.mp.s.bond.lengthHydrogen, element: "H" });
                }
            }
            for (; this.getBondCount() < 4; ) {
                this.cmap = this.calculateConnectionMap();
                var o = this.calculateNewBondAngle();
                this.addNewBond({ a: o, length: this.mp.s.bond.lengthHydrogen, element: "H" });
            }
        }
    }),
    ...
    (MPAtom.prototype.centerChanged = function () {
        this.invalidate();
        for (var t = 0; t < this.bonds.length; t++) this.mp.mol.bonds[this.bonds[t]].invalidate(), this.mp.mol.atoms[this.mp.mol.bonds[this.bonds[t]].getOppositeAtom(this.index)].bondsChanged(!0);
        this.cmap = this.calculateConnectionMap();
    }),
    (MPAtom.prototype.labelChanged = function () {
        this.invalidate(), (this.line = void 0);
        for (var t = 0; t < this.bonds.length; t++) this.mp.mol.bonds[this.bonds[t]].invalidate(), this.mp.mol.atoms[this.mp.mol.bonds[this.bonds[t]].getOppositeAtom(this.index)].bondsChanged();
    }),
    (MPAtom.prototype.bondsChanged = function (t) {
        if ((this.invalidate(), this.mp.s.skeletalDisplay)) for (var e = 0; e < this.bonds.length; e++) this.mp.mol.bonds[this.bonds[e]].invalidate();
    }),
    ...
    (MPAtom.prototype.drawStateColor = function () {
        ...
        this.isHidden() ||
            void 0 === this.line ||
            (("hover" === this.display || "active" === this.display || ("normal" === this.display && this.isSelected())) &&
                ((t = this.isSelected() ? "selected" : this.display),
                this.mp.ctx.beginPath(),
                this.line.area.point
                    ? (this.mp.ctx.arc(this.center.x, this.center.y, this.mp.s.atom.selectionRadiusScaled, 0, PI2), (this.mp.ctx.fillStyle = this.mp.s.atom[t].color), this.mp.ctx.fill())
                    : (this.mp.ctx.moveTo(this.center.x + this.line.area.left, this.center.y),
                      ...
                      (this.mp.ctx.strokeStyle = this.mp.s.atom[t].color),
                      this.mp.ctx.stroke())));
    }),
    (MPAtom.prototype.drawLabel = function () {
        ...
        this.isHidden() ||
            void 0 === this.line ||
            (this.isVisible() &&
                (this.mp.s.atom.colored && (this.mp.ctx.fillStyle = JmolAtomColorsHashHex[this.element] || JmolAtomColorsHashHex.C),
                this.mp.s.atom.miniLabel
                    ? ((t = this.mp.s.atom.miniLabelSize), this.mp.ctx.fillRect(this.center.x - t / 2, this.center.y - t / 2, t, t))
                    : ((e = this.center.x + this.line.text.offsetLeft),
                      0 < this.isotope && (this.mp.setFont("isotope"), this.mp.ctx.fillText("" + this.isotope, e, this.center.y + this.line.text.offsetTop - this.line.text.isotopeHeight), (e += this.line.text.isotopeWidth)),
                      this.mp.setFont("element"),
                      this.mp.ctx.fillText("" + this.element, e, this.center.y + this.line.text.offsetTop),
                      (e += this.line.text.labelWidth),
                      0 !== this.charge && (this.mp.setFont("charge"), this.mp.ctx.fillText(this.getChargeLabel(), e, this.center.y + this.line.text.offsetTop - this.line.text.chargeHeight)))));
    }),
    (MPAtom.prototype.calculateConnectionMap = function () {
        if (0 === this.bonds.length) return 0;
        for (var t = [], e = 0; e < this.bonds.length; e++) t.push({ i: this.bonds[e], a: this.mp.mol.bonds[this.bonds[e]].getAngle(this) });
        t.sort(function (t, e) {
            return t.a - e.a;
        });
        for (var o = [], e = 0; e < t.length; e++) {
            var i = 0 === e ? t.length - 1 : e - 1;
            o.push({ from: i, to: e, a: angleBetween(t[i].a, t[e].a) });
        }
        return { bondMap: t, sections: o };
    }),
    ...
    (MPAtom.prototype.calculateCenterLine = function () {
        if (this.mp.s.atom.miniLabel) return { text: { offsetLeft: 0, offsetTop: 0 }, area: { point: !0 } };
        var t = this.mp.s.atom.scale,
            e = {};
        this.mp.setFont("element"), (e.labelWidth = this.mp.ctx.measureText("" + this.element).width);
        var o = e.labelWidth;
        0 < this.isotope &&
            (this.mp.setFont("isotope"), (e.isotopeHeight = this.mp.s.fonts.isotope.fontSize * t), (e.isotopeWidth = this.mp.ctx.measureText("" + this.isotope).width + this.mp.s.atom.isotope.padding * t), (o += e.isotopeWidth)),
            0 !== this.charge &&
                (this.mp.setFont("charge"),
                (e.chargeHeight = this.mp.s.fonts.charge.fontSize * t),
                (e.chargeWidth = this.mp.ctx.measureText("" + this.getChargeLabel()).width),
                (e.labelWidth += this.mp.s.atom.charge.padding * t),
                (o += e.chargeWidth + this.mp.s.atom.charge.padding * t));
        ...
        if (((e.offsetLeft = -s), (e.offsetTop = i / 2), o > this.mp.s.atom.circleClamp)) {
            ...
            return { text: e, area: { half: s + n, left: n - s, right: s - n } };
        }
        return { text: e, area: { point: !0 } };
    }),
    ...
    (MPAtom.prototype._calculateBondVertices = function (t, e) {
        if (t.x === this.center.x || this.hidden || void 0 === this.line) {
            for (var o = [], i = this.isVisible() ? this.mp.s.atom.radius : 0, s = t.y < this.center.y, n = 0; n < e.length; n++) o.push(MPPFO({ x: this.center.x + (s ? e[n] : -e[n]), y: this.center.y + (s ? -i : i) }));
            return o;
        }
        if (t.y === this.center.y) {
            for (var o = [], i = this.isVisible() ? this.line.area.half || this.mp.s.atom.radius : 0, a = t.x > this.center.x, n = 0; n < e.length; n++)
                o.push(MPPFO({ x: this.center.x + (a ? i : -i), y: this.center.y + (a ? e[n] : -e[n]) }));
            return o;
        }
        if (this.isVisible()) {
            var h = this.center,
                r = this.center,
                l = 1;
            this.line.area.left && t.x < this.center.x
                ? (h = new MPPoint(this.center.x + this.line.area.left, this.center.y))
                : this.line.area.right && t.x > this.center.x && ((h = new MPPoint(this.center.x + this.line.area.right, this.center.y)), (l = -1));
            for (
                var c = Math.abs(h.x - r.x),
                    i = this.mp.s.atom.radius,
                    d = t.x - r.x,
                    m = t.y - r.y,
                    p = d / (M = Math.sqrt(d * d + m * m)),
                    u = 0 < l ? i - p * c : i + p * c,
                    f = p * u,
                    g = (b = m / M) * u,
                    y = r.x + f,
                ...
                o.push(MPPFO({ x: y - b * e[n], y: P + p * e[n] }));
            return o;
        }
        if (1 === e.length && 0 === e[0]) return [MPPFO({ x: this.center.x, y: this.center.y })];
        for (var M, d = t.x - this.center.x, m = t.y - this.center.y, p = d / (M = Math.sqrt(d * d + m * m)), b = m / M, o = [], n = 0; n < e.length; n++) o.push(MPPFO({ x: -b * e[n], y: p * e[n] }));
        for (n = 0; n < o.length; n++) (o[n].x += this.center.x), (o[n].y += this.center.y);
        return o;
    }),
        ...
        return "atom" === this.mp.tool.type
            ? {
                  ...
                  onPointerDown: function (t, e) {
                      (this.data = { atom: -1, oldElement: this.scope.element }), this.scope.setElement(e.tool.data.element);
                  },
                  onPointerMove: function (t, e) {
                      var o = new MPPoint().fromRelativePointer(t, e);
                      o.inCircle(this.scope.center, e.s.atom.minAddRotateLength) ||
                          (-1 === this.data.atom &&
                              (this.scope.setElement(this.data.oldElement),
                              (this.data.startAngle = this.scope.calculateNewBondAngle()),
                              (this.data = this.scope.addNewBond({ a: this.data.startAngle, type: e.tool.data.type || MP_BOND_SINGLE, stereo: e.tool.data.stereo || MP_STEREO_NONE, element: e.tool.data.element }))),
            ...
            ? {
                  ...
                  onPointerDown: function (t, e) {
                      ...
                      this.data = this.scope.addNewBond({ a: o, type: e.tool.data.type || MP_BOND_SINGLE, stereo: e.tool.data.stereo || MP_STEREO_NONE, element: e.tool.data.element });
                  },
                  onPointerMove: function (t, e) {
                      for (var o, i = new MPPoint().fromRelativePointer(t, e), s = e.mol.bonds[this.data.bond], n = 0; n < e.mol.atoms.length; n++) {
                          if (n !== this.scope.index && n !== this.data.atom)
                              if (e.mol.atoms[n].handle(i, "active"))
                                  return void (
                                      s.to !== n &&
                                      (e.mol.atoms[s.to].setDisplay("normal"),
                                      e.mol.atoms[s.to].removeBond(s.index),
                                      e.mol.atoms[this.data.atom].setDisplay("hidden"),
                                      s.setTo(n),
                                      e.mol.atoms[n].addBond(s.index),
                                      -1 !== (o = this.scope.getNeighborBond(n)) && o !== this.data.bond
                                          ? o !== this.data.neighbor && ((this.data.neighbor = o), e.mol.bonds[o].setDisplay("hidden"))
                                          : void 0 !== this.data.neighbor && (e.mol.bonds[this.data.neighbor].setDisplay("normal"), (this.data.neighbor = void 0)))
                                  );
                      }
                      s.to !== this.data.atom &&
                          (e.mol.atoms[this.data.atom].setDisplay("normal"),
                          void 0 !== this.data.neighbor && (e.mol.bonds[this.data.neighbor].setDisplay("normal"), (this.data.neighbor = void 0)),
                          e.mol.atoms[s.to].removeBond(s.index),
                          e.mol.atoms[this.data.atom].addBond(s.index),
                          s.setTo(this.data.atom)),
                          i.inCircle(this.scope.center, e.s.atom.minAddRotateLength) || (this.data.currentAngle = e.mol.rotateAtoms(this.scope.center, i, [this.data.atom], this.data.currentAngle, this.data.startAngle, e.s.rotateSteps));
                  },
                  onPointerUp: function (t, e) {
            ...
            ? {
                  ...
                  onPointerDown: function (t, e) {
                      ...
                      (this.data = { frag: MPFragments.translate(MPFragments.scale(MPFragments.translate(MPFragments.clone(e.tool.data.frag.toAtom), o ? 1 : 0, 0), e.s.bond.length), this.scope.center.x, this.scope.center.y) }),
                          e.sel.clear(),
                      ...
                      var i,
                          s = e.mol.createFragment(this.data.frag, !0);
                      o
                          ? ((i = new MPBond(e, { i: e.mol.bonds.length, type: MP_BOND_SINGLE, stereo: MP_STEREO_NONE, from: this.scope.index, to: s.atoms[0], selected: !0 })),
                            e.mol.bonds.push(i),
                            e.mol.atoms[i.to].addBond(i.index),
                            this.scope.addBond(i.index),
                            this.scope.select(!0))
                          : e.mol.mergeAtoms(s.atoms[0], this.scope.index);
                  },
                  onPointerMove: function (t, e) {
                      var o = new MPPoint().fromRelativePointer(t, e);
            ...
            ? {
                  scope: this,
                  data: { startAngle: 0, length: this.mp.s.bond.length * Math.cos(this.mp.s.chain.devAngle), chain: [], ra: void 0 },
                  onDraw: function (t) {
                      (t.ctx.strokeStyle = t.s.chain.strokeStyle),
                          (t.ctx.lineWidth = t.s.bond.width * t.s.bond.scale),
                          (t.ctx.lineCap = t.s.chain.lineCap),
                          (t.ctx.lineJoin = t.s.chain.lineJoin),
                          t.ctx.setLineDash([2 * t.s.bond.scale, 5 * t.s.bond.scale]),
                          t.ctx.beginPath();
                      ...
                      t.ctx.stroke(),
                          0 < this.data.chain.length &&
                              (t.setFont("chainSize"),
                              (t.ctx.fillStyle = t.s.chain.color),
                              (e = "" + this.data.size),
                              (o = t.ctx.measureText(e).width),
                              (i = t.s.atom.scale * t.s.fonts.chainSize.fontSize),
                              (s = this.data.chain[this.data.chain.length - 1].clone()),
                              (n = t.s.atom.scale * t.s.chain.padding + (i < o ? o : i)),
                              (s.x += n * Math.cos(this.data.a)),
                              (s.y += n * Math.sin(-this.data.a)),
                              (s.x -= o / 2),
                              (s.y += i / 2),
                              t.ctx.fillText(e, s.x, s.y));
                  },
                  onPointerDown: function (t, e) {
                      (this.data.startAngle = this.scope.calculateNewBondAngle()),
                          1 === this.scope.bonds.length
                              ? (this.data.ra = posRad(e.mol.bonds[this.scope.bonds[0]].getAngle(this.scope) + Math.PI))
                              : 2 === this.scope.bonds.length
                  ...
                  onPointerMove: function (t, e) {
                      ...
                      if (i !== this.data.a || s !== this.data.size) {
                          ...
                          var n,
                              a = this.data.a > -Math.PI / 2 && this.data.a < Math.PI / 2 ? 1 : -1,
                          ...
                          this.data.chain = [];
                          for (var m = this.scope.center.clone(), p = 0; p < this.data.size; p++) p % 2 == 0 ? this.data.chain.push(MPPFO({ x: m.x + c, y: m.y + d })) : ((m.x += 2 * r), (m.y += 2 * l), this.data.chain.push(m.clone()));
                  ...
                  onPointerUp: function (t, e) {
                      for (var o = this.scope, i = [], s = 1; s < this.data.chain.length; s++) {
                          var n = new MPAtom(e, { i: e.mol.atoms.length, x: this.data.chain[s].x, y: this.data.chain[s].y, element: "C" });
                          e.mol.atoms.push(n), i.push(n.index);
                          var a = new MPBond(e, { i: e.mol.bonds.length, from: o.index, to: n.index, type: MP_BOND_SINGLE });
            ...
            : {
                  ...
                  onPointerMove: function (t, e) {
                      ...
                      (Math.sqrt(i * i + s * s) > e.s.draggingThreshold || this.data.moved) &&
                          ((this.data.moved = !0),
                          this.scope.isSelected() ? (e.sel.hasCenter() && e.sel.centerAtom !== this.scope.index ? e.sel.rotate(o) : e.sel.translate(i, s)) : this.scope.translate(o.x - e.pointer.old.r.x, o.y - e.pointer.old.r.y),
                          (e.pointer.old.r = o));
                  },
                  onPointerUp: function (t, e) {
                      !this.data.moved && oneOf(e.tool.type, ["select", "drag"]) ? this.scope.select(!this.scope.isSelected()) : this.scope.isSelected() ? e.sel.collapse() : e.mol.collapseAtoms([this.scope.index], !0),
...
(MPBond.prototype.getKetcherData = function () {
    return new chem.Struct.Bond({ type: this.type, stereo: this.stereo, begin: this.from, end: this.to });
}),
    (MPBond.prototype.getConfig = function () {
        return { i: this.index, type: this.type, stereo: this.stereo, from: this.from, to: this.to };
    }),
    ...
    (MPBond.prototype.getLine = function () {
        return new MPLine({ from: this.mp.mol.atoms[this.from].center, to: this.mp.mol.atoms[this.to].center });
    }),
    ...
    (MPBond.prototype.drawStateColor = function () {
        ...
        this.isHidden() ||
            ...
            (("hover" === this.display || "active" === this.display || ("normal" === this.display && this.isSelected())) &&
                ...
                (e = this.line.from),
                (o = this.line.to),
                this.mp.mol.atoms[this.from].isSelected() && (e = this.mp.mol.atoms[this.from].center),
                this.mp.mol.atoms[this.to].isSelected() && (o = this.mp.mol.atoms[this.to].center),
                this.mp.ctx.moveTo(e.x, e.y),
                this.mp.ctx.lineTo(o.x, o.y),
                (this.mp.ctx.strokeStyle = this.mp.s.bond[t].color),
                this.mp.ctx.stroke()));
    }),
    (MPBond.prototype.drawBond = function () {
        if (!this.isHidden() && void 0 !== this.line) {
            ...
            var t = this.mp.ctx;
            if ((this.mp.s.bond.colored && !this.mp.s.atom.miniLabel && ((t.strokeStyle = this.cache.bondColor), this.stereo === MP_STEREO_UP && (t.fillStyle = this.cache.bondColor)), this.mp.getScale() < this.mp.s.bond.singleOnlyScale))
                t.beginPath(), t.moveTo(this.line.from.x, this.line.from.y), t.lineTo(this.line.to.x, this.line.to.y), t.stroke();
            else if (this.stereo === MP_STEREO_CIS_TRANS && this.type === MP_BOND_DOUBLE)
                t.beginPath(),
                    t.moveTo(this.cache.ctd.from[0].x, this.cache.ctd.from[0].y),
                    t.lineTo(this.cache.ctd.to[0].x, this.cache.ctd.to[0].y),
                    t.moveTo(this.cache.ctd.from[1].x, this.cache.ctd.from[1].y),
                    t.lineTo(this.cache.ctd.to[1].x, this.cache.ctd.to[1].y),
                    t.stroke();
            else if (this.stereo === MP_STEREO_UP)
                t.beginPath(),
                    t.moveTo(this.cache.wedge.far[0].x, this.cache.wedge.far[0].y),
                    t.lineTo(this.cache.wedge.near[0].x, this.cache.wedge.near[0].y),
                    t.lineTo(this.line.to.x, this.line.to.y),
                    t.lineTo(this.cache.wedge.near[1].x, this.cache.wedge.near[1].y),
                    t.closePath(),
                    t.fill(),
                    t.stroke();
                ...
                t.stroke();
            } else if (this.type === MP_BOND_SINGLE) t.beginPath(), t.moveTo(this.line.from.x, this.line.from.y), t.lineTo(this.line.to.x, this.line.to.y), t.stroke();
    ...
    (MPBond.prototype.validate = function () {
        if (!this.valid)
            if (
                ((this.valid = !0),
                this.mp.mol.atoms[this.from].center.distanceTo(this.mp.mol.atoms[this.to].center) <= ((this.mp.mol.atoms[this.from].isVisible() ? 1 : 0) + (this.mp.mol.atoms[this.to].isVisible() ? 1 : 0)) * this.mp.s.atom.radius)
            )
                this.hidden = !0;
            else {
                this.hidden = !1;
                var t,
                    ...
                    g,
                    y,
                    P = this.mp.s.bond.scale;
                if (
                    ((this.cache = {}),
                    (this.line = { from: this.mp.mol.atoms[this.from].calculateBondVertices(this.to, [0])[0], to: this.mp.mol.atoms[this.to].calculateBondVertices(this.from, [0])[0] }),
                    (this.line.center = new MPPFO({ x: (this.line.from.x + this.line.to.x) / 2, y: (this.line.from.y + this.line.to.y) / 2 })),
                    this.mp.s.bond.colored
                        ? ((t = this.mp.mol.atoms[this.from]),
                          (e = this.mp.mol.atoms[this.to]),
                          this.stereo === MP_STEREO_UP
                              ? (this.cache.bondColor = JmolAtomColorsHashHex.C)
                              : t.element === e.element
                              ? (this.cache.bondColor = JmolAtomColorsHashHex[t.element] || JmolAtomColorsHashHex.C)
                              : ((this.cache.bondColor = this.mp.ctx.createLinearGradient(t.getX(), t.getY(), e.getX(), e.getY())),
                                this.cache.bondColor.addColorStop(this.mp.s.bond.gradient.from, JmolAtomColorsHashHex[t.element] || JmolAtomColorsHashHex.C),
                                this.cache.bondColor.addColorStop(this.mp.s.bond.gradient.to, JmolAtomColorsHashHex[e.element] || JmolAtomColorsHashHex.C)))
                        : (this.cache.bondColor = this.mp.s.bond.color),
                    this.mp.getScale() >= this.mp.s.bond.singleOnlyScale)
                )
                    if (this.stereo === MP_STEREO_CIS_TRANS && this.type === MP_BOND_DOUBLE) {
                        ...
                        this.cache.ctd = { from: this.mp.mol.atoms[this.from].calculateBondVertices(this.to, M), to: this.mp.mol.atoms[this.to].calculateBondVertices(this.from, M) };
                    } else if (this.stereo === MP_STEREO_UP) {
                        (this.cache.wedge = {
                            ...
                            this.mp.mol.atoms[this.to].isVisible() ||
                                (o = this.mp.mol.atoms[this.to].calculateClosestBonds(this.index)).none ||
                                (this.mp.mol.bonds[o.lower].type != MP_BOND_SINGLE ||
                                    (void 0 !== (i = this.mp.mol.bonds[o.lower].getLine().intersection(new MPLine({ from: this.cache.wedge.far[0], to: this.cache.wedge.near[0] }))).p &&
                                        this.line.to.distanceTo(i.p) < this.mp.s.bond.wedgeFitMaxD &&
                                        (this.cache.wedge.near[0] = i.p || this.cache.wedge.near[0])),
                                this.mp.mol.bonds[o.upper].type != MP_BOND_SINGLE ||
                                    (void 0 !== (s = this.mp.mol.bonds[o.upper].getLine().intersection(new MPLine({ from: this.cache.wedge.far[0], to: this.cache.wedge.near[1] }))).p &&
                                        this.line.to.distanceTo(s.p) < this.mp.s.bond.wedgeFitMaxD &&
                                        (this.cache.wedge.near[1] = s.p || this.cache.wedge.near[1])));
                    } else if (this.stereo === MP_STEREO_DOWN) {
                        ...
                        for (this.cache.hashLines = []; 0 < B - D - C; ) {
                            var R = (B - D - C) / B;
                            (B *= R), (v *= R), (S *= R), (w *= R), (A *= R), this.cache.hashLines.push({ from: { x: b[0].x + v, y: b[0].y + S }, to: { x: b[0].x + w, y: b[0].y + A } });
                        }
                    } else {
                        (this.type !== MP_BOND_DOUBLE && this.type !== MP_BOND_TRIPLE) ||
                            ((M = []),
                            (g = 1),
                            (n = this.mp.mol.atoms[this.from].calculateClosestBonds(this.index)),
                            (a = this.mp.mol.atoms[this.to].calculateClosestBonds(this.index)),
                            (r = h = !1),
                            (l =
                                this.mp.s.skeletalDisplay &&
                                (!this.mp.mol.atoms[this.from].isVisible() || !this.mp.mol.atoms[this.to].isVisible()) &&
                                !(1 === this.mp.mol.atoms[this.from].bonds.length && ((this.mp.mol.atoms[this.from].isVisible() && 2 < this.mp.mol.atoms[this.to].bonds.length) || 1 === this.mp.mol.atoms[this.to].bonds.length)) &&
                                !(1 === this.mp.mol.atoms[this.to].bonds.length && ((this.mp.mol.atoms[this.to].isVisible() && 2 < this.mp.mol.atoms[this.from].bonds.length) || 1 === this.mp.mol.atoms[this.from].bonds.length))) &&
                                ((d = c = this.line.from.distanceTo(this.line.to)),
                                (m = 0),
                                n.upperSectionAngle < Math.PI
                                    ? (this.mp.mol.atoms[this.from].isVisible() || (d -= 8 / Math.tan(n.upperSectionAngle / 2)), (m += Math.abs(this.mp.s.bond.bestBisect - n.upperSectionAngle / 2)))
                                    : (m += Math.abs(this.mp.s.bond.bestBisect - Math.PI / 2)),
                                a.lowerSectionAngle < Math.PI
                                    ? (this.mp.mol.atoms[this.to].isVisible() || (d -= 8 / Math.tan(a.lowerSectionAngle / 2)), (m += Math.abs(this.mp.s.bond.bestBisect - a.lowerSectionAngle / 2)))
                                    : (m += Math.abs(this.mp.s.bond.bestBisect - Math.PI / 2)),
                                (p = c),
                                (u = 0),
                                n.lowerSectionAngle < Math.PI
                                    ? (this.mp.mol.atoms[this.from].isVisible() || (p -= 8 / Math.tan(n.lowerSectionAngle / 2)), (u += Math.abs(this.mp.s.bond.bestBisect - n.lowerSectionAngle / 2)))
                                    : (u += Math.abs(this.mp.s.bond.bestBisect - Math.PI / 2)),
                                a.upperSectionAngle < Math.PI
                                    ? (this.mp.mol.atoms[this.to].isVisible() || (p -= 8 / Math.tan(a.upperSectionAngle / 2)), (u += Math.abs(this.mp.s.bond.bestBisect - a.upperSectionAngle / 2)))
                                    : (u += Math.abs(this.mp.s.bond.bestBisect - Math.PI / 2)),
                                Math.abs(n.upperSectionAngle - a.upperSectionAngle) + Math.abs(n.lowerSectionAngle - a.lowerSectionAngle) < this.mp.s.bond.angleDev
                                    ? (g = (f = this.mp.mol.atoms[this.from].center.angleTo(this.mp.mol.atoms[this.to].center)) > -Math.PI / 2 + this.mp.s.bond.angleDev && f <= Math.PI / 2 + this.mp.s.bond.angleDev ? 1 : -1)
                                    : (u < m || (d < this.mp.s.atom.radius && p > this.mp.s.atom.radius)) && (g = -1),
                                (h = (this.type === MP_BOND_TRIPLE || 1 === g) && d > this.mp.s.atom.radius),
                                (r = (this.type === MP_BOND_TRIPLE || -1 === g) && p > this.mp.s.atom.radius)),
                            this.type === MP_BOND_DOUBLE ? ((M = this.mp.s.bond.delta[MP_BOND_DOUBLE]), l && (M = transformArrayAdd(M, -g * M[0]))) : this.type === MP_BOND_TRIPLE && (M = this.mp.s.bond.delta[MP_BOND_TRIPLE]),
                            (M = transformArrayMult(M, -this.mp.s.bond.deltaScale)),
                            (y = transformArrayMult(M, -1)),
                            (this.cache.bond = { from: this.mp.mol.atoms[this.from].calculateBondVertices(this.to, M), to: this.mp.mol.atoms[this.to].calculateBondVertices(this.from, y) }),
                            this.mp.mol.atoms[this.from].isVisible() ||
                                n.none ||
                                ((!l || r) &&
                                    n.lowerSectionAngle < Math.PI &&
                                    (this.cache.bond.from[0] = this.refineBondVertex(l, n.lowerBisectAngle, this.line.from, this.cache.bond.from[0], this.cache.bond.to[0], this.mp.mol.bonds[n.lower].getLine())),
                                (!l || h) &&
                                    n.upperSectionAngle < Math.PI &&
                                    (this.cache.bond.from[1] = this.refineBondVertex(l, n.upperBisectAngle, this.line.from, this.cache.bond.from[1], this.cache.bond.to[1], this.mp.mol.bonds[n.upper].getLine()))),
                            this.mp.mol.atoms[this.to].isVisible() ||
                                a.none ||
                                ((!l || r) &&
                                    a.upperSectionAngle < Math.PI &&
                                    (this.cache.bond.to[0] = this.refineBondVertex(l, a.upperBisectAngle, this.line.to, this.cache.bond.to[0], this.cache.bond.from[0], this.mp.mol.bonds[a.upper].getLine())),
                                (!l || h) &&
                                    a.lowerSectionAngle < Math.PI &&
                                    (this.cache.bond.to[1] = this.refineBondVertex(l, a.lowerBisectAngle, this.line.to, this.cache.bond.to[1], this.cache.bond.from[1], this.mp.mol.bonds[a.lower].getLine()))));
                    }
            }
    }),
    (MPBond.prototype.refineBondVertex = function (t, e, o, i, s, n) {
        ...
        return (
            t
                ? (a = new MPLine({ from: o, to: MPPFO({ x: o.x + Math.cos(e), y: o.y + Math.sin(-e) }) }).intersection(new MPLine({ from: i, to: s })))
                : (!(a = n.intersection(new MPLine({ from: i, to: s }))).onL1 || o.distanceTo(a.p) > n.length() / 2) && (a.p = void 0),
            void 0 !== a.p ? a.p : i
        );
    }),
        ...
        return "bond" === this.mp.tool.type
            ? {
                  ...
                  onPointerDown: function (t, e) {
                      ...
                      e.tool.data.type
                          ? (this.scope.setType(
                                e.tool.data.type === MP_BOND_TRIPLE
                                    ? MP_BOND_TRIPLE
                                    : this.scope.type === MP_BOND_TRIPLE || this.scope.stereo !== MP_STEREO_NONE
                                    ? e.tool.data.type
                                    : this.scope.type === MP_BOND_SINGLE
                                    ? MP_BOND_DOUBLE
                                    : MP_BOND_SINGLE
                            ),
                            this.scope.setStereo(MP_STEREO_NONE))
                          : e.tool.data.stereo &&
                            (this.scope.setType(MP_BOND_SINGLE), this.scope.stereo === e.tool.data.stereo ? ((o = this.scope.from), this.scope.setFrom(this.scope.to), this.scope.setTo(o)) : this.scope.setStereo(e.tool.data.stereo));
                  },
              }
            ...
            ? {
                  scope: this,
                  onPointerDown: function (t, e) {
                      this.scope.isSelected() ? e.sel.remove() : e.mol.removeBond(this.scope.index), (e.pointer.handler = void 0);
                  },
              }
            : {
                  scope: this,
                  ...
                  onPointerMove: function (t, e) {
                      ...
                      (Math.sqrt(i * i + s * s) > e.s.draggingThreshold || this.data.moved) &&
                          ((this.data.moved = !0),
                          this.scope.isSelected() && 0 < e.sel.cache.atoms.length ? e.sel.translate(i, s) : (e.mol.atoms[this.scope.from].translate(i, s), e.mol.atoms[this.scope.to].translate(i, s)),
                          (e.pointer.old.r = o));
                  },
                  onPointerUp: function (t, e) {
                      var o;
                      !this.data.moved && oneOf(e.tool.type, ["select", "drag"])
                          ? ((o = !this.scope.isSelected()), this.scope.select(o), 0 === e.sel.cache.atoms.length && (e.mol.atoms[this.scope.from].select(o), e.mol.atoms[this.scope.to].select(o)))
                          : this.scope.isSelected()
                          ? e.sel.collapse()
                          : e.mol.collapseAtoms([this.scope.from, this.scope.to], !0),
                          e.sel.updateRotationCenter();
                  },
              };
    }),
    ...
    (MolPad.prototype.loadSettings = function () {
        this.s = {
            ...
            rotateSteps: 12,
            fonts: {
                element: { fontStyle: "bold", fontFamily: "sans-serif", fontSize: 12 },
                charge: { fontStyle: "bold", fontFamily: "sans-serif", fontSize: 8 },
                isotope: { fontStyle: "bold", fontFamily: "sans-serif", fontSize: 8 },
                chainSize: { fontStyle: "normal", fontFamily: "sans-serif", fontSize: 12 },
            },
            atom: {
                hover: { color: "#bfb" },
                active: { color: "#8f8" },
                ...
                maxMiniLabelScale: 0.2,
                miniLabelSize: 25,
                miniLabel: !1,
            },
            bond: {
                gradient: { from: 0.4, to: 0.6 },
                color: "#111",
                colored: !0,
                hover: { color: "#bfb" },
                active: { color: "#8f8" },
                selected: { color: "#8f8" },
                delta: [[], [0], [-4, 4], [-8, 8], [-6, 6], [0, 8]],
                length: 55,
                lengthHydrogen: 34,
                radius: 8,
                lineCap: "round",
            ...
            chain: { rotateSteps: 12, devAngle: Math.PI / 6, padding: 2, color: "#f50", strokeStyle: "#f50", lineCap: "round", lineJoin: "round" },
            select: { fillStyle: "rgba(255, 85, 0, 0.3)", strokeStyle: "#f50", lineWidth: 2, lineCap: "round", lineJoin: "round" },
        };
    });
var MP_ZOOM_TO_COG = 0,
    MP_ZOOM_TO_POINTER = 1;
function MolPad(t, e, o) {
    this.loadSettings(),
        (this.tool = { type: "bond", data: { type: MP_BOND_SINGLE }, selection: [] }),
...
function MPMolecule(t) {
    (this.atoms = []), (this.bonds = []), (this.stack = []), (this.reverseStack = []), (this.copy = { atoms: [], bonds: [], fingerprint: "" }), (this.mp = t);
}
function MPSelection(t) {
    (this.cache = { atoms: [], bonds: [] }), (this.mirrorSide = 1), (this.startAngle = 0), (this.currentAngle = 0), (this.mp = t);
}
(MolPad.prototype.setTool = function (t, e) {
    (this.tool.type = t), (this.tool.data = e);
}),
    (MolPad.prototype.onChange = function (t) {
        this.changeCallback = t;
    }),
    (MolPad.prototype.clear = function (t) {
        this.mol.clear(), this.sel.update(), this.scaleAbsolute(1 / this.matrix[0], this.width() / 2, this.height() / 2), this.redraw(!0), this.mol.updateCopy();
    }),
    (MolPad.prototype.changed = function () {
        jQuery(this.buttons.undo).toggleClass("tool-button-disabled", 0 === this.mol.stack.length),
            jQuery(this.buttons.redo).toggleClass("tool-button-disabled", 0 === this.mol.reverseStack.length),
            void 0 !== this.changeCallback && this.changeCallback();
    }),
    (MolPad.prototype.undo = function (t) {
        this.dismissHandler(), this.mol.undo(t) && this.changed();
    }),
    (MolPad.prototype.redo = function () {
        this.dismissHandler(), this.mol.redo() && this.changed();
    }),
    ...
    (MPMolecule.prototype.exec = function (t, e, o) {
        if (e) for (var i = 0; i < this.atoms.length; i++) if (t.call(this.mp, this.atoms[i])) return;
        if (o) for (i = 0; i < this.bonds.length; i++) if (t.call(this.mp, this.bonds[i])) return;
    }),
    (MPMolecule.prototype.loadMOL = function (t) {
        ...
        e.atoms.each(function (t, e) {
            var o = new MPAtom(i.mp, { i: t, x: e.pp.x * i.mp.s.bond.length, y: e.pp.y * i.mp.s.bond.length, element: e.label, charge: e.charge, isotope: e.isotope });
            i.atoms.push(o);
        }),
            e.bonds.each(function (t, e) {
                var o = new MPBond(i.mp, { i: t, type: e.type, stereo: e.stereo, from: e.begin, to: e.end });
                i.bonds.push(o), i.atoms[e.begin].bonds.push(o.index), i.atoms[e.end].bonds.push(o.index);
            });
    }),
    ...
    (MPMolecule.prototype.getPlainData = function () {
        for (var t = { atoms: [], bonds: [] }, e = 0; e < this.atoms.length; e++) t.atoms.push(this.atoms[e].getConfig());
    ...
    (MPMolecule.prototype.createFragment = function (t, e) {
        for (var o = { atoms: [], bonds: [] }, i = 0; i < t.atoms.length; i++) {
            var s = new MPAtom(this.mp, { i: this.atoms.length, x: t.atoms[i].center.x, y: t.atoms[i].center.y, element: t.atoms[i].element, selected: e });
            this.atoms.push(s), o.atoms.push(s.index);
        }
        for (i = 0; i < t.bonds.length; i++) {
            var n = new MPBond(this.mp, { i: this.bonds.length, type: t.bonds[i].type, stereo: MP_STEREO_NONE, from: o.atoms[t.bonds[i].from], to: o.atoms[t.bonds[i].to], selected: e });
            this.bonds.push(n), o.bonds.push(n.index), this.atoms[n.from].addBond(n.index), this.atoms[n.to].addBond(n.index);
        }
    ...
    (MPMolecule.prototype.mergeAtoms = function (t, e, o) {
        var i = this.atoms[t],
            s = this.atoms[e];
        o && s.center.replace(i.center), s.select(i.isSelected() || s.isSelected());
        for (var n = 0; n < i.bonds.length; n++) {
            var a = s.getNeighborBond(this.bonds[i.bonds[n]].getOppositeAtom(t));
            -1 === a
                ? (this.bonds[i.bonds[n]].replaceAtom(t, e), s.addBond(i.bonds[n]))
                : (this.bonds[a].select(this.bonds[i.bonds[n]].isSelected() || this.bonds[a].isSelected()), this.bonds[i.bonds[n]].type === MP_BOND_SINGLE && this.bonds[a].setType(MP_BOND_SINGLE));
        }
    ...
    (MPMolecule.prototype.countCollapses = function (t) {
        for (var e = 0, o = 0; o < t.length; o++) for (var i = 0; i < this.atoms.length; i++) -1 === t.indexOf(i) && this.atoms[t[o]].center.inCircle(this.atoms[i].center, this.mp.s.atom.radiusScaled) && e++;
        return e;
    }),
    ...
    (MPMolecule.prototype.updateIndices = function () {
        ...
        return this.mp.sel.update(), { amap: t, bmap: e };
    }),
    (MPMolecule.prototype.getBBox = function () {
        if (0 === this.atoms.length) return { x: 0, y: 0, width: 1, height: 1 };
        for (var t = void 0, e = void 0, o = 0; o < this.atoms.length; o++) {
            ...
            void 0 === t ? (t = { x: s, y: a }) : (t.x > s && (t.x = s), t.y > a && (t.y = a)), void 0 === e ? (e = { x: n, y: a }) : (e.x < n && (e.x = n), e.y < a && (e.y = a));
        }
        var h = this.mp.s.atom.radius;
        return { x: t.x - h, y: t.y - h, width: e.x - t.x + 2 * h, height: e.y - t.y + 2 * h };
    }),
    (MPMolecule.prototype.updateCopy = function () {
        var t = this.getFingerprint();
        t !== this.copy.fingerprint &&
            ((this.reverseStack = []), this.stack.push(this.copy), this.stack.length > this.mp.s.maxStackSize && this.stack.shift(), (this.copy = this.getPlainData()), (this.copy.fingerprint = t), this.mp.changed());
    }),
    ...
    (MPSelection.prototype.update = function () {
        (this.cache.atoms = []), (this.cache.bonds = []);
    ...
    (MolPad.prototype.update = function () {
        ...
        (this.s.atom.miniLabel = this.getScale() <= this.s.atom.maxMiniLabelScale),
            (this.s.atom.scale = this.getScale() < this.s.atom.minScale ? this.s.atom.minScale / this.getScale() : 1),
            (this.s.bond.deltaScale = this.getScale() < this.s.bond.minDeltaScale ? this.s.bond.minDeltaScale / this.getScale() : 1),
            (this.s.bond.scale = this.getScale() < this.s.bond.minScale ? this.s.bond.minScale / this.getScale() : 1),
    ...
    (MolPad.prototype.draw = function () {
        ...
        for (var t = 0; t < this.mol.bonds.length; t++) this.mol.bonds[t].drawStateColor();
        (this.ctx.lineWidth = 2 * this.s.atom.selectionRadiusScaled), (this.ctx.lineCap = this.s.atom.lineCap);
        for (t = 0; t < this.mol.atoms.length; t++) this.mol.atoms[t].drawStateColor();
        (this.ctx.fillStyle = this.ctx.strokeStyle = this.s.bond.color), (this.ctx.lineWidth = this.s.bond.width * this.s.bond.scale), (this.ctx.lineCap = this.s.bond.lineCap), (this.ctx.lineJoin = this.s.bond.lineJoin);
        for (t = 0; t < this.mol.bonds.length; t++) this.mol.bonds[t].drawBond();
        this.ctx.fillStyle = this.ctx.strokeStyle = this.s.atom.color;
        for (t = 0; t < this.mol.atoms.length; t++) this.mol.atoms[t].drawLabel();
        this.pointer.handler && this.pointer.handler.onDraw && this.pointer.handler.onDraw(this), this.ctx.restore();
    }),
    (MolPad.prototype.redraw = function (t) {
        t && (this.updated = !1), this.pendingFrame || ((this.pendingFrame = !0), requestAnimationFrame(this.draw.bind(this)));
    }),
    (MolPad.prototype.center = function () {
        var t, e, o, i;
        0 !== this.mol.atoms.length &&
            (this.resetMatrix(),
            (t = this.mol.getBBox()),
            (e = this.width() / t.width) < (o = this.height() / t.height)
                ? (this.scale(e), this.translate(-t.x * e, -t.y * e + (this.height() - t.height * e) / 2))
                : (this.scale(o), this.translate(-t.x * o + (this.width() - t.width * o) / 2, -t.y * o)),
            (i = 1 - 2 * this.s.relativePadding),
            this.scaleAbsolute(i, this.width() / 2, this.height() / 2),
            this.redraw(!0));
    }),
    ...
    (MolPad.prototype.translate = function (t, e) {
        (this.matrix[4] += t), (this.matrix[5] += e);
    }),
    (MolPad.prototype.scale = function (t) {
        (this.matrix[0] *= t), (this.matrix[3] *= t);
    }),
    ...
    (MolPad.prototype.setupEventHandling = function () {
        (this.keys = { ctrl: !1 }), (this.pointer = { old: { p: new MPPoint(), r: new MPPoint(), c: new MPPoint(), d: 0 }, handler: void 0, touches: 0, touchGrab: !1 });
        var e = this;
        this.container.on("DOMMouseScroll mousewheel", function (t) {
            ...
            this.container.on("contextmenu", function (t) {
                return !1;
            }),
            this.container.on("mousedown touchstart", function (t) {
                e.onPointerDown(t), e.clearRedrawRequest();
            }),
            this.container.on("mousemove", function (t) {
                e.onMouseMoveInContainer(t), e.clearRedrawRequest();
            }),
            this.container.on("mouseout", function (t) {
                e.onMouseOut(t), e.clearRedrawRequest();
            }),
            jQuery(window).on("mousemove touchmove", function (t) {
                e.onPointerMove(t), e.clearRedrawRequest();
            }),
            jQuery(window).on("mouseup touchend touchcancel", function (t) {
                e.onPointerUp(t), e.clearRedrawRequest();
            }),
            jQuery(window).on("blur", function (t) {
                e.onBlur(t);
            }),
            0 <= navigator.platform.toLowerCase().indexOf("mac")
                ? (jQuery(document).bind("keydown", "meta+z", function (t) {
                      t.preventDefault(), e.undo();
                  }),
                  jQuery(document).bind("keydown", "meta+y", function (t) {
                      t.preventDefault(), e.redo();
                  }),
                  jQuery(document).bind("keydown", "meta+shift+z", function (t) {
                      t.preventDefault(), e.redo();
                  }))
                : (jQuery(document).bind("keydown", "ctrl+z", function (t) {
                      t.preventDefault(), e.undo();
                  }),
                  jQuery(document).bind("keydown", "ctrl+y", function (t) {
                      t.preventDefault(), e.redo();
                  }),
                  jQuery(document).bind("keydown", "ctrl+shift+z", function (t) {
                      t.preventDefault(), e.redo();
                  })),
            jQuery(document).on("keydown", function (t) {
                (e.keys.ctrl = t.ctrlKey), 46 === t.keyCode && (e.sel.remove(), e.clearRedrawRequest());
            }),
            jQuery(document).on("keyup", function (t) {
                e.keys.ctrl = t.ctrlKey;
            });
    }),
    (MolPad.prototype.onScroll = function (t, e) {
        ...
        if (((i.x -= this.offset.left), (i.y -= this.offset.top), this.s.zoomType === MP_ZOOM_TO_COG)) {
            ...
            s.divide(this.mol.atoms.length), s.multiplyX(this.matrix[0]), s.multiplyY(this.matrix[3]), s.addX(this.matrix[4]), s.addY(this.matrix[5]), s.divide(this.devicePixelRatio), this.scaleAbsolute(o, s.x, s.y);
    ...
    (MolPad.prototype.onPointerDown = function (t) {
        ...
        this.pointer.old.p.fromPointer(t),
            ...
            oneOf(this.tool.type, ["erase", "select", "drag"]) || this.sel.clear(),
            e.targetTouches && 1 < e.targetTouches.length
                ? (this.pointer.handler && this.pointer.handler.onPointerUp && this.pointer.handler.onPointerUp(t, this),
                  this.mol.isChanged() ? this.mol.loadPlainData(this.mol.copy) : this.resetEventDisplay(),
                  this.pointer.old.c.fromMultiTouchCenter(t),
                  (this.pointer.old.d = getMultiTouchDelta(t)),
                  (this.pointer.handler = this.multiTouchHandler))
                : 1 === t.which || (e.targetTouches && 1 === e.targetTouches.length)
                ? (this.handleEvent(this.pointer.old.r, "active", function (t) {
                      this.pointer.handler = t.getHandler(this);
                  }),
                  void 0 === this.pointer.handler && (this.pointer.handler = this.getHandler()))
                : (2 !== t.which && 3 !== t.which) || (this.pointer.handler = this.mouseDragHandler),
            this.pointer.handler && this.pointer.handler.onPointerDown && this.pointer.handler.onPointerDown(t, this);
    }),
    ...
    (MolPad.prototype.onPointerUp = function (t) {
        var e;
        ("mouseup" === t.type && this.pointer.touchGrab) ||
            ((e = t.originalEvent),
            this.pointer.handler
                ? (this.pointer.handler.onPointerUp && this.pointer.handler.onPointerUp(t, this),
                  this.pointer.handler.scope ? (this.setCursor("pointer"), this.resetEventDisplay(), this.pointer.handler.scope.setDisplay("mouseup" === t.type ? "hover" : "normal")) : this.setCursor("default"))
                : this.setCursor("default"),
            e.targetTouches
                ? 1 < e.targetTouches.length
                    ? ((this.pointer.old.d = getMultiTouchDelta(t)), (this.pointer.old.c = new MPPoint().fromMultiTouchCenter(t)))
                    : 1 === e.targetTouches.length
                    ? ((this.pointer.old.p = new MPPoint().fromPointer(t)), this.pointer.old.r.fromRelativePointer(t, this), void 0 !== this.pointer.handler && (this.pointer.handler = this.mouseDragHandler))
                    : ((this.pointer.handler = void 0), this.mol.updateCopy())
                : ((this.pointer.handler = void 0), this.mol.updateCopy()));
    }),
    (MolPad.prototype.onBlur = function (t) {
        (this.keys.ctrl = !1), this.dismissHandler();
    }),
    ...
    (MolPad.prototype.multiTouchHandler = {
        onPointerMove: function (t, e) {
            var o, i;
            t.originalEvent.targetTouches.length <= 1
                ? e.dismissHandler()
                : ((o = new MPPoint().fromMultiTouchCenter(t)),
                  (i = getMultiTouchDelta(t)),
                  e.translate((o.x - e.pointer.old.c.x) * e.devicePixelRatio, (o.y - e.pointer.old.c.y) * e.devicePixelRatio),
                  e.scaleAbsolute(i / e.pointer.old.d, (o.x - e.offset.left) * e.devicePixelRatio, (o.y - e.offset.top) * e.devicePixelRatio),
                  (e.pointer.old.c = o),
                  (e.pointer.old.d = i),
                  e.pointer.old.p.fromPointer(t),
                  e.redraw(!0));
        },
    }),
    (MolPad.prototype.selectionToolHandler = {
        ...
        onDraw: function (t) {
            if (
                ((t.ctx.fillStyle = t.s.select.fillStyle),
                (t.ctx.strokeStyle = t.s.select.strokeStyle),
                (t.ctx.lineWidth = t.s.select.lineWidth / t.getScale()),
                (t.ctx.lineCap = t.s.select.lineCap),
                (t.ctx.lineJoin = t.s.select.lineJoin),
                t.ctx.setLineDash([2 / t.getScale(), 5 / t.getScale()]),
                t.ctx.beginPath(),
                "rect" === t.tool.data.type && this.data.rect)
            )
                t.ctx.rect(this.data.rect.x, this.data.rect.y, this.data.rect.width, this.data.rect.height), t.ctx.fill(), t.ctx.stroke();
        ...
        onPointerDown: function (t, e) {
            ...
            var o = new MPPoint().fromRelativePointer(t, e);
            e.keys.ctrl ? (this.data.selAdd = { atoms: e.sel.cache.atoms.slice(), bonds: e.sel.cache.bonds.slice() }) : (e.sel.clear(), (this.data.selAdd = { atoms: [], bonds: [] })),
                "rect" === e.tool.data.type ? (this.data.rect = { x: o.x, y: o.y, width: 0, height: 0 }) : (this.data.points = [o.clone()]);
        },
        onPointerMove: function (t, e) {
            e.setCursor("default");
            var o,
                i,
                s = new MPPoint().fromRelativePointer(t, e);
            "rect" === e.tool.data.type
                ? ((this.data.rect.width = s.x - this.data.rect.x),
                  (this.data.rect.height = s.y - this.data.rect.y),
                  (o = this.data.rect),
                  e.mol.exec(
                      function (t) {
        ...
        onPointerUp: function (t, e) {
            e.sel.updateRotationCenter(), e.requestRedraw();
        },
    }),
    (MolPad.prototype.getHandler = function () {
        return "atom" === this.tool.type
            ? {
                  onPointerDown: function (t, e) {
                      var o = new MPPoint().fromRelativePointer(t, e),
                          i = new MPAtom(e, { i: e.mol.atoms.length, x: o.x, y: o.y, element: e.tool.data.element });
                      e.mol.atoms.push(i), (e.pointer.handler.scope = i);
                  },
              }
            : "bond" === this.tool.type
            ? {
                  onPointerDown: function (t, e) {
                      var o = new MPPoint().fromRelativePointer(t, e),
                          i = new MPAtom(e, { i: e.mol.atoms.length, x: o.x - e.s.bond.length / 2, y: o.y, element: "C", selected: !0 });
                      e.mol.atoms.push(i);
                      var s = new MPAtom(e, { i: e.mol.atoms.length, x: o.x + e.s.bond.length / 2, y: o.y, element: "C", selected: !0 });
                      e.mol.atoms.push(s);
                      var n = new MPBond(e, { i: e.mol.bonds.length, from: i.index, to: s.index, type: e.tool.data.type, stereo: e.tool.data.stereo, selected: !0 });
                      e.mol.bonds.push(n), i.addBond(n.index), s.addBond(n.index), (e.pointer.handler.scope = n), e.sel.update(), (e.sel.center = o.clone()), (e.sel.currentAngle = e.sel.startAngle = 0.5 * Math.PI);
                  },
                  onPointerMove: function (t, e) {
                      var o = new MPPoint().fromRelativePointer(t, e);
                      e.sel.rotate(o);
            ...
            ? {
                  onPointerDown: function (t, e) {
                      ...
                      e.mol.createFragment(i, !0), (e.sel.center = o.clone()), (e.sel.currentAngle = e.sel.startAngle = 0);
                  },
                  onPointerMove: function (t, e) {
                      var o = new MPPoint().fromRelativePointer(t, e);
                      e.sel.rotate(o);
            ...
            ? {
                  onPointerDown: function (t, e) {
                      var o = new MPPoint().fromRelativePointer(t, e),
                          i = new MPAtom(e, { i: e.mol.atoms.length, x: o.x, y: o.y, element: "C" });
                      e.mol.atoms.push(i), (e.pointer.handler = i.getHandler());
                  },
              }
            : "select" === this.tool.type
