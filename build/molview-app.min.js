/*! MolView JavaScript App, built on 2022-03-22 */
...
var History = {
    ...
    Sketcher = {
        molpad: void 0,
        metadata: { cid: void 0, inchi: void 0, inchikey: void 0, smiles: void 0 },
        init: function () {
            MPFragments.init(),
                this.initPeriodicTable(),
                this.resizeToolbars(),
                $("#action-mp-color-mode").toggleClass("tool-button-selected", Preferences.get("sketcher", "colored", !0)),
                $("#action-mp-skeletal-formula").toggleClass("tool-button-selected", !Preferences.get("sketcher", "skeletal_formula", !0)),
                Detector.canvas
                    ? ((this.molpad = new MolPad(document.getElementById("molpad-canvas-wrapper"), MolView.devicePixelRatio, { undo: "#action-mp-undo", redo: "#action-mp-redo" })),
                      this.molpad.setSkeletalDisplay(Preferences.get("sketcher", "skeletal_formula", !0)),
                      this.setColored(Preferences.get("sketcher", "colored", !0)),
        ...
        resizeToolbars: function () {
            ...
            $("#edit-tools").css({ left: t, height: e }), $("#chem-tools").css({ width: t }), $("#elem-tools").css({ top: e, width: o }), $("#molpad-canvas-wrapper").css({ top: e, left: t, right: o });
        },
                ...
                for (var o = -1, a = 0; a < e[t].elements.length; a++) {
                    ...
                    if ("" !== s.name) {
                        ...
                        $('<div class="pt-element"></div>')
                            .attr("title", s.name)
                            .append($("<h3></h3>").html(s.number))
                            .append($("<h4></h4>").html(s.small).css("color", JmolAtomColorsHashHex[s.small]))
                            .data("element", s.small)
    ...
    SearchGrid = {
        ...
        init: function () {
            $("#search-layer").on("scroll", function (e) {
                $("#search-layer").scrollTop() + $("#search-layer").outerHeight() > $("#search-layer > .container").outerHeight() &&
                    ("pubchem" === SearchGrid.db ? Actions.load_more_pubchem() : "rcsb" === SearchGrid.db ? Actions.load_more_rcsb() : "cod" === SearchGrid.db && Actions.load_more_cod());
            });
        },
        clear: function () {
        ...
        setDatabase: function (e) {
            (this.db = e),
                $("#action-load-more-pubchem").css("display", "pubchem" === e ? "block" : "none"),
                $("#action-load-more-rcsb").css("display", "rcsb" === e ? "block" : "none"),
                $("#action-load-more-cod").css("display", "cod" === e ? "block" : "none");
        },
        ...
        addEntry: function (e) {
            if ("pubchem" === this.db) {
                if (!e.CID) return;
                var t = $('<a class="search-result search-result-pubchem"></a>')
                    .attr("href", "?cid=" + e.CID)
                ...
                ((s = new Image()).onload = function () {
                    ...
                    (s.src = Request.PubChem.image(e.CID, t.width())),
                    $("<div class='search-result-img'></div>")
                        ...
                        .height(t.width())
                        .appendTo(o.appendTo(t)),
                    t.data("cid", e.CID),
                    t.data("title", ucfirst(humanize(e.Title))),
                ...
                var s,
                    i = 500 / MolView.devicePixelRatio,
                    o = $('<div class="search-result-img-wrap"></div>');
                ((s = new Image()).onload = function () {
                    o.css("background-image", "none");
                }),
                    (s.src = Request.RCSB.image(e.structureId)),
                    $('<div class="search-result-img"></div>')
                        .css("background-image", "url(" + s.src + ")")
                        .css("background-size", 250 < i ? 250 : i)
                        .height(t.width())
                        .appendTo(o.appendTo(t));
                var n = $('<div class="search-result-description">' + ucfirst(humanize(e.structureTitle)) + "</div>");
                t.append(n),
                    a.data("pdbid", e.structureId),
                ...
                e.title &&
                    $('<div class="expandable"><div class="expandable-title"><span>Details</span></div><div class="expandable-content">' + formatHTMLLinks(formatMFormula(e.title)) + "</div></div>")
                        .appendTo(n)
                        .children(".expandable-title")
                        .on(MolView.trigger, function (e) {
                            $(this).parent().toggleClass("open");
                        }),
                    e.mineral && $("<p><b>Mineral name</b><br/><span>" + e.mineral + "</span></p>").appendTo(n),
                    e.commonname && $("<p><b>Common name</b><br/><span>" + e.commonname + "</span></p>").appendTo(n),
                    e.chemname && $("<p><b>Chemical name</b><br/><span>" + e.chemname + "</span></p>").appendTo(n),
                    e.formula && $("<p><b>Molecular formula</b><br/><span>" + formatMFormula(e.formula.replace(/-/g, "").replace(/\s/g, "")) + "</span></p>").appendTo(n),
                    a.data("codid", e.codid),
                    a.data("title", r),
                    a.on("click", function (e) {
    ...
    Loader = {
        lastQuery: { type: "", content: "" },
        setQuery: function (e, t, o) {
            (t = String(t)),
                (this.lastQuery.type = e),
                (this.lastQuery.content = t),
                History.push(e, t, o),
                $("#model-source").removeClass("disabled"),
                "q" === e || "smiles" === e
                    ? $("#model-source").text("3D model source").removeAttr().addClass("disabled")
                    : "cid" === e
                    ? $("#model-source").text("PubChem source").attr("href", Request.PubChem.staticURL(t))
                    : "pdbid" === e
                    ? $("#model-source").text("RCSB source").attr("href", Request.RCSB.staticURL(t))
                    : "codid" === e && $("#model-source").text("COD source").attr("href", Request.COD.staticURL(t));
        },
        CIRsearch: function (e, t) {
            var o;
            Request.CIR.available
                ? (t || Progress.reset(3),
                  (o = e || $("#search-input").val()),
                  Request.CIRsearch(
                      o,
                      function (e, t, o) {
        ...
        PubChem: {
            ...
            loadNextSet: function () {
                var e, t;
                this.loading ||
                    (this.i < Request.PubChem.data.length &&
                        ((this.loading = !0),
                        SearchGrid.startLoading(),
                        (e = this.i),
                        (t = this.i + this.step) > Request.PubChem.data.length && (t = Request.PubChem.data.length),
                        this.loadCIDS(Request.PubChem.data.slice(e, t)),
                        (this.i = t)));
            },
            search: function () {
                var e = $("#search-input").val();
                Progress.reset(3),
                    Request.PubChem.search(
                        e,
                        function () {
            ...
            structureSearch: function (e, t, o) {
                Progress.reset(3),
                    Request.PubChem.structureSearch(
                        e,
                        t,
                        o,
                        function (o) {
            ...
            loadName: function (t, e) {
                Progress.reset(e ? 9 : 6),
                    Messages.process(function () {
                        Request.PubChem.nameToCID(
                            t,
                            function (e) {
        ...
        RCSB: {
            ...
            step: 10,
            loading: !1,
            loadPDBIDS: function (e) {
                0 !== e.length &&
                    Request.RCSB.information(
                        e,
                        function (e) {
            ...
            loadNextSet: function () {
                var e, t;
                this.loading ||
                    (this.i < Request.RCSB.data.length &&
                        ((this.loading = !0), SearchGrid.startLoading(), (e = this.i), (t = this.i + this.step) > Request.RCSB.data.length && (t = Request.RCSB.data.length), this.loadPDBIDS(Request.RCSB.data.slice(e, t)), (this.i = t)));
            },
            search: function () {
                var e = $("#search-input").val();
                Progress.reset(3),
                            ...
                            Request.RCSB.PDB(
                                ...
                                function (e) {
                                    Detector.webgl
                                        ? Model.isGLmol()
                                            ? (Model.loadPDB(e), o())
                                            : (Model.preloadPDB(e), Model.setRenderEngine("GLmol", o))
                                        : MolView.mobile
                                        ? Messages.alert("mobile_old_no_macromolecules")
                                        : Model.isJSmol()
                                        ? (Model.loadPDB(e), o())
                                        : (Model.preloadPDB(e), Model.setRenderEngine("JSmol", o));
                                },
                                function () {
                                    Messages.alert("load_fail");
                                }
            ...
            Request.resolve(
                ...
                function (e, t) {
                    Messages.alert("resolved_3d_unreliable"),
                        Model.loadMOL(e),
                        Sketcher.markUpdated(),
                        0 < t ? ((Sketcher.metadata.cid = t), Loader.setQuery("cid", t)) : Loader.setQuery("smiles", o),
                        Progress.complete(),
                        Messages.clear(),
                        (document.title = "MolView"),
                        "sketcher" === MolView.layout && MolView.setLayout("model");
                },
                function () {
                    Messages.alert("load_fail");
                }
                        ...
                        Progress.increment(),
                            ...
                            Request.resolve(
                                ...
                                function (e, t) {
                                    Sketcher.loadMOL(e),
                                        Sketcher.markUpdated(),
                                        0 < t ? ((Sketcher.metadata.cid = t), Loader.setQuery("cid", t, !0)) : Loader.setQuery("smiles", o),
                                        Progress.complete(),
                                        Messages.clear(),
                                        (document.title = a || "MolView");
                                },
                                function () {
                                    Messages.alert("load_fail");
                                }
    ...
    Actions = {
        ...
        search_substructure: function () {
            MolView.hideDialogs(),
                ...
                Messages.process(function () {
                    if (Sketcher.metadata.cid) Loader.PubChem.structureSearch("cid", Sketcher.metadata.cid, "substructure");
                    else {
                        var e;
                        try {
                            e = Sketcher.getSMILES();
        ...
        search_superstructure: function () {
            MolView.hideDialogs(),
                MolView.setLayer("main"),
                Messages.process(function () {
                    if (Sketcher.metadata.cid) Loader.PubChem.structureSearch("cid", Sketcher.metadata.cid, "superstructure");
                    else {
                        var e;
                        try {
                            e = Sketcher.getSMILES();
        ...
        search_similarity: function () {
            MolView.hideDialogs(),
                MolView.setLayer("main"),
                Messages.process(function () {
                    if (Sketcher.metadata.cid) Loader.PubChem.structureSearch("cid", Sketcher.metadata.cid, "similarity");
                    else {
                        var e;
                        try {
                            e = Sketcher.getSMILES();
        ...
        export_spectrum_png: function () {
            var e, t;
            Spectroscopy.data[$("#spectrum-select").val()]
                ? ((e = document.getElementById("spectrum-canvas").toDataURL("image/png")), null !== (t = dataURItoBlob(e)) && saveAs(t, $("#spectrum-select").find("option:selected").text() + ".png"))
                : alert("No spectrum selected!");
        },
        export_spectrum_jcamp: function () {
            var e;
            Spectroscopy.data[$("#spectrum-select").val()]
                ? null !== (e = new Blob([Spectroscopy.data[$("#spectrum-select").val()]], { type: "chemical/x-jcamp-dx;charset=utf-8" })) && saveAs(e, $("#spectrum-select").find("option:selected").text() + ".jdx")
                : alert("No spectrum selected!");
        },
    };
            ...
            ? ((t = $(this)).empty().unbind(),
              o
                  ? AJAX({
                        ...
                        dataType: "jsonp",
                        success: function (e) {
                            t.data("total_count", e[0].total_count),
                                $("<span></span>")
                                    .html(e[0].total_count + " Likes")
                                    .appendTo(t);
                        },
                    })
                  : $("<span></span>").html("Facebook").appendTo(t),
              t.on("click", function () {
            ...
            : $(this).hasClass("share-twitter") &&
              ...
              o
                  ? AJAX({
                        ...
                        dataType: "jsonp",
                        success: function (e) {
                            t.data("count", e.count),
                                $("<span></span>")
                                    .html(e.count + " Tweets")
                                    .appendTo(t);
                        },
                    })
                  : $("<span></span>").html("Twitter").appendTo(t),
              t.on("click", function () {
...
var Link = {
        ...
        updateShareDialog: function () {
            ...
            var e = window.location.origin + window.location.pathname,
                t = "";
            "" !== Loader.lastQuery.type && ((t = "Cool structure on MolView!"), (e += "?" + Loader.lastQuery.type + "=" + specialEncodeURIComponent(Loader.lastQuery.content.replace(/^ /, "")))),
                $("#share-link").val(e),
                $("#share-dialog .social").share({ all: e }, !1, t);
        },
        updateEmbedDialog: function () {
            ...
            oneOf(Loader.lastQuery.type, ["smiles", "cid", "pdbid", "codid"]) && (e += "&" + Loader.lastQuery.type + "=" + specialEncodeURIComponent(Loader.lastQuery.content.replace(/^ /, ""))),
                "black" !== Model.bg.colorName && (e += "&bg=" + Model.bg.colorName),
                Model.isPDB() &&
                    (("ribbon" !== Model.chain.type && "cylinders" !== Model.chain.type && "btube" !== Model.chain.type && "ctrace" !== Model.chain.type) || (e += "&chainType=" + Model.chain.type),
                    Model.chain.bonds && ("none" === Model.chain.type ? (e += "&chainType=bonds") : (e += "&chainBonds=true")),
                    Model.chain.color && (e += "&chainColor=" + Model.chain.color)),
                (Link.embedHTML = '<iframe style="width: ' + $("#embed-width").val() + "; height: " + $("#embed-height").val() + ';" frameborder="0" src="' + e + '"></iframe>'),
    ...
    InfoCard = {
        ...
        load: function () {
            this.updated ||
                ((this.updated = !0),
                this.updateImage(),
                this.loadProperty("cid", function (e) {
                    e && $("#pubchem-link").attr("href", Request.PubChem.staticURL(e)).show(),
                        ...
                        InfoCard.loadProperty("csid", function (e) {
                            e &&
                                $("#chemspider-link")
                                    .attr("href", "http://www.chemspider.com/Chemical-Structure." + e + ".html")
                                    .show();
                        }),
                        e &&
                            Request.PubChem.description(e, function (e) {
                                for (var t, o, a = 0; a < e.InformationList.Information.length; a++)
                                    void 0 === t && void 0 !== e.InformationList.Information[a].Title && (t = ucfirst(humanize(e.InformationList.Information[a].Title))),
                                        void 0 === o && void 0 !== e.InformationList.Information[a].Description && (o = e.InformationList.Information[a].Description);
        ...
        processFormula: function (e) {
            ...
            return (
                ...
                jQuery.each(this.data.molecule, function (e, t) {
                    $("#percent-composition-table").append(
                        "<tr>\t\t\t\t<td>" +
                            e +
                            "</td>\t\t\t\t<td>" +
                            ElementsMolarTable[e] +
                            " u &times; " +
                            t +
                            "</td>\t\t\t\t<td>" +
                            (((ElementsMolarTable[e] * t) / o) * 100).toPrecision(InfoCard.percentCompositionPrecision) +
                            " %</td>\t\t\t</tr>"
                    );
                }),
                formatMFormula(e)
        ...
        getPropertyFromPubChem: function (o, a, s) {
            -1 === InfoCard.data.cid
                ...
                : InfoCard.data.cid && "cas" === o
                ? Request.PubChem.casNumber(
                      InfoCard.data.cid,
                      function (e) {
                ...
                ? InfoCard.PubChem_cache
                    ? InfoCard.loadFrom_PubChem_cache(o, a, function () {
                          InfoCard.getPropertyFromCIR(o, a, s);
                      })
                    : InfoCard.data.cid &&
                      ((InfoCard.PubChem_cache = { loading: !0 }),
                      Request.PubChem.properties(
                          InfoCard.data.cid,
                          PubChemPropNames,
                          function (e) {
        ...
        getPropertyFromCIR: function (t, o, e) {
            InfoCard.data.smiles && void 0 !== CIRProps[t]
        ...
        loadFrom_PubChem_cache: function (e, t, o) {
            ...
            !InfoCard.PubChem_cache || InfoCard.PubChem_cache.failed
                ? o()
                : InfoCard.PubChem_cache.loading
    ...
    Spectroscopy = {
            ...
            "undefined" != typeof ChemDoodle &&
                ...
                MolView.mobile
                    ? ($("#spectrum-wrapper").on("touchmove", function (e) {
                      ...
                      (this.spectrum_ratio = 2),
                      (this.spectrum = new ChemDoodle.ObserverCanvas("spectrum-canvas", 100, 100)))
                    : (this.spectrum = new ChemDoodle.SeekerCanvas("spectrum-canvas", 100, 100, ChemDoodle.SeekerCanvas.SEEK_PLOT)),
                (this.spectrum.specs.plots_showYAxis = !0),
                (this.spectrum.specs.plots_flipXAxis = !0),
                (this.spectrum.specs.plots_showGrid = !0),
        ...
        update: function (e) {
            ...
            (this.data = {}),
                ...
                InfoCard.getProperty(
                    "cas",
                    function (e) {
                        (Spectroscopy.data.cas = e),
                            Request.NIST.lookup(
                                Spectroscopy.data.cas,
                                function (e) {
                                    if (
                                        ...
                                        e.mass && $("#spectrum-select").append('<option value="nist-mass">Mass spectrum</option>'),
                                        void 0 !== e.ir)
                                    )
                                        for (var t = 0; t < e.ir.length; t++) $("#spectrum-select").append('<option value="nist-ir-' + e.ir[t].i + '">IR spectrum [' + e.ir[t].state + "]</option>");
        ...
        load: function (t) {
            ...
            this.print("Loading…"),
                ...
                "nmrdb" === t
                    ? this.data.nmrdb
                        ? o()
                        : InfoCard.getProperty("smiles", function (e) {
                              Request.NMRdb.prediction(
                                  e,
                                  function (e) {
        ...
        resize: function () {
            var e = $("#spectrum-wrapper").width(),
                t = Math.round(e / Spectroscopy.spectrumRatio);
            Spectroscopy.spectrum.resize(e * MolView.devicePixelRatio, t * MolView.devicePixelRatio), $("#spectrum-canvas").css({ width: e * MolView.devicePixelRatio, height: t * MolView.devicePixelRatio });
        },
    };
...
AutocompleteBuilder.prototype.sort = function (e, t, o) {
    e = e.toLowerCase();
    for (var a = this.array.slice(0), s = 0; s < a.length; s++)
        (a[s].similarity = similar_text(e, a[s][this.key].toLowerCase(), !0)), 0 === a[s][this.key].toLowerCase().indexOf(e) && (a[s].similarity += 100), t && a[s].similarity < t && (a.splice(s, 1), s--);
    return a
        .sort(function (e, t) {
...
var Autocomplete = {
        ...
        focusRecord: function (e) {
            ...
            var t,
                o = $(".autocomplete-item").eq(e);
            -1 !== e &&
                (o.addClass("autocomplete-item-active"),
                (t = o.position()).top + o.outerHeight() > $("#autocomplete-dropdown").outerHeight()
                    ? $("#autocomplete-dropdown").scrollTop($("#autocomplete-dropdown").scrollTop() - $("#autocomplete-dropdown").outerHeight() + t.top + o.outerHeight())
                    : t.top < 0 && $("#autocomplete-dropdown").scrollTop($("#autocomplete-dropdown").scrollTop() + t.top));
        },
        keydown: function (e) {
        ...
        refresh: function () {
            var o,
                a = $("#search-input").val().toLowerCase();
            if (Autocomplete.cache[a]) Autocomplete.display(Autocomplete.cache[a]);
            else {
                if (a.length > Autocomplete.maxLength) return;
                a.length < Autocomplete.minLength
                    ? Autocomplete.display([])
                    : ((o = []),
                      (o =
                          !MolView.macromolecules || (!Detector.webgl && MolView.mobile)
                              ? this.minerals.sort(a, this.MIN_SIM, this.MAX_NUMBER).slice(0)
                              : this.macromolecules.sort(a, this.MIN_SIM, this.MAX_NUMBER).slice(0).concat(this.minerals.sort(a, this.MIN_SIM, this.MAX_NUMBER).slice(0))),
                      this.getPubChemAutocomplete(a, function (e) {
                          for (var t = 0; t < e.length; t++) e[t].label = ucfirst(humanize(e[t].name));
                          o = new AutocompleteBuilder((o = o.concat(e)), "label").sort(a);
                          for (t = 0; t < o.length; t++)
                              t < o.length - 1 && o[t].label === o[t + 1].label && ((o[t].codid = o[t].codid || o[t + 1].codid), (o[t].PubChem_name = o[t].PubChem_name || o[t + 1].PubChem_name), o.splice(t + 1, 1));
        ...
        display: function (e) {
            ...
            for (var t = $("<ul></ul>"), o = $("#search-input").val().toLowerCase(), a = 0; a < e.length; a++) {
                ...
                0 === e[a].label.toLowerCase().indexOf(o)
                    ? $('<span class="autocomplete-label"></span>')
                          .html("<b>" + e[a].label.substr(0, o.length) + "</b>" + e[a].label.substr(o.length))
                          .appendTo(s)
                    : $('<span class="autocomplete-label"></span>').html(e[a].label).appendTo(s),
                    e[a].pdbids
                        ? (s.addClass("autocomplete-macromolecule"), $('<span class="autocomplete-type"></span>').html(PDBNames.types[e[a].type]).appendTo(s))
                        : e[a].codid
                        ? (s.addClass("autocomplete-mineral"), $('<span class="autocomplete-type"></span>').html("Mineral").appendTo(s))
                        : (s.addClass("autocomplete-pubchem"), $('<span class="autocomplete-type"></span>').html("Compound").appendTo(s)),
                    $('<div style="clear: both;"></div>').appendTo(s),
                    s.data("i", a),
                    s.on(MolView.trigger, function () {
        ...
        submit: function () {
            if ((MolView.pushEvent("input", "submit", "autocomplete", 0), "" === $("#search-input").val())) $("#search-input").focus(), MolView.alertEmptyInput();
            else {
                if ((this.hide(), $("#search-input").blur(), MolView.hideDialogs(), MolView.setLayer("main"), -1 === this.i))
                    for (var e = 0; e < this.records.length; e++)
                        if (this.records[e].name.toLowerCase() == $("#search-input").val().toLowerCase()) {
                            this.i = e;
                            break;
                        }
                var t;
                -1 === this.i
                    ? ((t = $("#search-input").val()), void 0 === Autocomplete.cache[t] ? Loader.PubChem.loadName(t, !0) : Messages.process(Loader.CIRsearch, "search"))
                    : ($("#search-input").val(this.records[this.i].label),
                      this.records[this.i].pdbids
                          ? Loader.RCSB.loadPDBID(this.records[this.i].pdbids[0], this.records[this.i].label)
                          : this.records[this.i].codid
                          ? Loader.COD.loadCODID(this.records[this.i].codid, this.records[this.i].label, this.records[this.i].PubChem_name)
        ...
        getPubChemAutocomplete: function (e, a) {
            AJAX({
                ...
                success: function (e) {
                    for (var t = [], o = 0; o < e.autocp_array.length; o++) t.push({ name: e.autocp_array[o], PubChem_name: e.autocp_array[o] });
                    a(t);
                },
            });
        },
    ...
    MolView = {
        ...
        init: function () {
            (window.onerror = function (e, t, o, a) {
                console.error(t + " " + o + "," + a + ": " + e);
            }),
                $(document).ajaxError(function (e, t, o) {
                    console.error("AJAX error: " + o.type + " " + o.url + ": " + t.statusText);
                }),
                ...
                (this.query.q || this.query.smiles || this.query.cid || this.query.pdbid) && (this.loadDefault = !1),
                Spectroscopy.init(),
                Autocomplete.init(),
                Request.init(),
                Sketcher.init(),
                SearchGrid.init(),
                this.touch && !Detector.webgl && ((this.macromolecules = !1), Model.JSmol.setQuality(!1)),
                (this.height = window.innerHeight),
                $(".dropdown-menu").css("max-height", $("#content").height() - 10),
                $("#main-layer").saveSize(),
                $(window).on("resize", function () {
                    $(".dropdown-menu").css("max-height", $("#content").height() - 10),
                        MolView.setMenuLayout($(window).width() < 1100, $(window).width() < 1100 && !MolView.touch, $(window).width() < 390 && MolView.touch),
                        Progress.resize(),
                        $("#main-layer").is(":hidden") || ($("#main-layer").saveSize(), Sketcher.resize(), Model.resize());
                }),
                ...
                $(window).on(this.trigger, function (e) {
                    var t = $(".dropdown.open .dropdown-menu"),
                        o = $("#search-input");
                    t.is(e.target) || 0 !== t.has(e.target).length || (e.stopPropagation(), $("#menu").removeClass("menu-open"), $(".dropdown").removeClass("open")),
                        o.is(e.target) || 0 !== o.has(e.target).length || "search-input" !== document.activeElement.id || $("#search-input").blur();
                }),
                ...
                this.addAction("layout_sketcher", "menu", !0),
                this.addAction("layout_model", "menu", !0),
                this.addAction("layout_vsplit", "menu", !0),
                this.addAction("layout_hsplit", "menu", !0),
                this.addAction("theme_desktop", "menu", !0),
                this.addAction("theme_touch", "menu", !0),
                this.addAction("help", "menu", !0),
                this.addAction("about", "menu", !0),
                this.addAction("share", "menu", !0),
                this.addAction("embed", "menu", !0),
                this.addAction("export_sketcher_png", "menu", !0),
                this.addAction("export_model_png", "menu", !0),
                this.addAction("export_model", "menu", !0),
                this.addAction("data_infocard", "menu", !0),
                this.addAction("data_spectra", "menu", !0),
                this.addAction("search_substructure", "menu", !0),
                this.addAction("search_superstructure", "menu", !0),
                this.addAction("search_similarity", "menu", !0),
                this.addAction("model_reset", "menu", !0),
                this.addAction("model_balls", "menu", !0),
                this.addAction("model_stick", "menu", !0),
                this.addAction("model_vdw", "menu", !0),
                this.addAction("model_wireframe", "menu", !0),
                this.addAction("model_line", "menu", !0),
                this.addAction("model_bg_black", "menu", !0),
                this.addAction("model_bg_gray", "menu", !0),
                this.addAction("model_bg_white", "menu", !0),
                this.addAction("engine_glmol", "menu", !0),
                this.addAction("engine_jmol", "menu", !0),
                this.addAction("engine_cdw", "menu", !0),
                this.addAction("cif_unit_cell", "menu", !0),
                this.addAction("cif_cubic_supercell", "menu", !0),
                this.addAction("cif_flat_supercell", "menu", !0),
                this.addAction("bio_assembly", "menu", !0),
                this.addAction("chain_type_ribbon", "menu", !0),
                this.addAction("chain_type_cylinders", "menu", !0),
                this.addAction("chain_type_btube", "menu", !0),
                this.addAction("chain_type_ctrace", "menu", !0),
                this.addAction("chain_type_bonds", "menu", !0),
                this.addAction("chain_color_ss", "menu", !0),
                this.addAction("chain_color_spectrum", "menu", !0),
                this.addAction("chain_color_chain", "menu", !0),
                this.addAction("chain_color_residue", "menu", !0),
                this.addAction("chain_color_polarity", "menu", !0),
                this.addAction("chain_color_bfactor", "menu", !0),
                this.addAction("jmol_hq", "menu", !0),
                this.addAction("jmol_clean", "menu", !0),
                this.addAction("jmol_mep_lucent", "menu", !0),
                this.addAction("jmol_mep_opaque", "menu", !0),
                this.addAction("jmol_charge", "menu", !0),
                this.addAction("jmol_bond_dipoles", "menu", !0),
                this.addAction("jmol_net_dipole", "menu", !0),
                this.addAction("jmol_minimize", "menu", !0),
                this.addAction("jmol_measure_distance", "menu", !0),
                this.addAction("jmol_measure_angle", "menu", !0),
                this.addAction("jmol_measure_torsion", "menu", !0),
                this.addAction("search_pubchem", "menu", !0),
                this.addAction("search_rcsb", "menu", !0),
                this.addAction("search_cod", "menu", !0),
                this.addAction("show_search_layer", "menu", !0),
                ...
                this.addAction("export_spectrum_png", "button", !0),
                this.addAction("export_spectrum_jcamp", "button", !0),
        ...
        addAction: function (t, o, a) {
            $("#action-" + t.replace(/_/g, "-")).on(this.trigger, function (e) {
                $(this).hasClass("disabled") ||
                    ...
                    (a && Preferences.get("molview", "allow_tracking", !1) ? MolView.pushEvent(o, "click", t.replace(/_/g, " "), Actions[t].call(this) || 0) : Actions[t].call(this));
            });
        },
        ...
        executeQuery: function () {
            $.each(this.query, function (e, t) {
                "q" === e
                    ? ($("#search-input").val(t), Messages.process(Loader.CIRsearch, "search"))
                    : "smiles" === e
                    ? Messages.process(function () {
                          Loader.loadSMILES(t, document.title);
                      }, "compound")
                    : "cid" === e
                    ? Loader.PubChem.loadCID(t, document.title)
                    : "pdbid" === e
                    ? Loader.RCSB.loadPDBID(t, t.toUpperCase())
                    : "bg" === e && Model.setBackground(t);
            });
        },
        ...
        setLayout: function (e) {
            $("#layout-menu > a").removeClass("selected"),
                $("#action-layout-" + e).addClass("selected"),
                $("#main-layer")
                    .removeClass("layout-sketcher layout-model layout-vsplit layout-hsplit")
                    .addClass("layout-" + e),
                (this.layout = e),
                this.setLayer("main", !0);
        },
        setMenuLayout: function (e, t, o) {
            $("#search").css("margin", t ? 0 : ""),
                $("#search-input").css("width", t ? 100 : o ? $(window).width() - 90 : ""),
                $("#brand").toggle(!t),
                $("#search-dropdown .dropdown-menu")
                    .toggleClass("dropdown-left", $(window).width() >= $("#search-dropdown .dropdown-menu").outerWidth() && !t)
                    .toggleClass("dropdown-compact", e),
                $("#jmol-dropdown .dropdown-menu, #protein-dropdown .dropdown-menu").toggleClass("dropdown-left", e);
        },
        setTheme: function (e) {
        ...
        alertEmptyInput: function () {
            null !== MolView.search_input_timeout && window.clearTimeout(MolView.search_input_timeout),
